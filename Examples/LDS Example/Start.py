...
from PyQt4.QtGui import QApplication, QImage, QPainter, QWidget,QPushButton,QTextEdit
import threading 
from PyQt4.QtCore import *
from PyQt4.QtGui import *
 
os.system("g++ src/Source.cpp -o a.out -I/usr/local/include -I armadillo-5.200.2/include -L/usr/local/lib -DARMA_DONT_USE_WRAPPER -lblas -llapack -lgsl -lgslcblas -lm") 
...
def print_time(tex,thread):
      ...
      #for i in range(100):
      #     tex.append("hello")
      os.system("python video.py Training_data/haarcascade_frontalface_default.xml 200 Video/Zoobi_doobi.mp4 "+str(thread.frame))
...
class VideoWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        layout = QVBoxLayout()
        self._capture = cv.CaptureFromFile( 'Video/Zoobi_doobi.mp4' )
        # Take one frame to query height
        self.count=0
        frame = cv.QueryFrame(self._capture)
        self.setMinimumSize(frame.width+300, frame.height)
